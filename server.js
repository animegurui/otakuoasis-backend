...
app.get('/trending', (req, res) => {
  res.json([
    { title: "Naruto", source: "gogo", slug: "naruto", poster: "" },
    { title: "One Piece", source: "gogo", slug: "one-piece", poster: "" },
    { title: "Attack on Titan", source: "gogo", slug: "attack-on-titan", poster: "" }
  ]);
});
...
app.get('/search', (req, res) => {
  const q = req.query.q || "";
  res.json([
    { title: `${q} Example Anime 1`, source: "gogo", slug: "example-anime-1", poster: "" },
    { title: `${q} Example Anime 2`, source: "gogo", slug: "example-anime-2", poster: "" }
  ]);
});

// Episodes list
app.get('/episodes/:source/:slug', (req, res) => {
  const episodes = [];
  for (let i = 1; i <= 5; i++) {
...
// Episode sources
app.get('/episode-sources/:source/:slug/:episodeNumber', (req, res) => {
  res.json([
    { url: "https://sample-videos.com/video123/mp4/720/big_buck_bunny_720p_1mb.mp4", quality: "720p" },
    { url: "https://sample-videos.com/video123/mp4/480/big_buck_bunny_480p_1mb.mp4", quality: "480p" }
  ]);
});
...
<style>
  ...
  .anime { color:#4CAF50; }
  .anime:hover { text-decoration:underline; }
  .source { color:#00BFFF; }
